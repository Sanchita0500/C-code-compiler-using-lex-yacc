...
const int YY_parse_CLASS::BUILTIN=258;
const int YY_parse_CLASS::ID=259;
const int YY_parse_CLASS::OPEN_SQ=260;
const int YY_parse_CLASS::CLOSE_SQ=261;
const int YY_parse_CLASS::EQ=262;
const int YY_parse_CLASS::NEW=263;
const int YY_parse_CLASS::SC=264;
const int YY_parse_CLASS::COMMA=265;
const int YY_parse_CLASS::DIGIT=266;
const int YY_parse_CLASS::MAIN=267;
const int YY_parse_CLASS::LOOP=268;
const int YY_parse_CLASS::OPEN_C=269;
const int YY_parse_CLASS::CLOSE_C=270;
const int YY_parse_CLASS::OPEN=271;
const int YY_parse_CLASS::CLOSE=272;
const int YY_parse_CLASS::SLASH=273;
const int YY_parse_CLASS::COMMENT=274;
const int YY_parse_CLASS::RETURN=275;
...
#define YYTRANSLATE(x) ((unsigned)(x) <= 275 ? yytranslate[x] : 23)
...
static const short yyprhs[] = {     0,
     0,     5,    18,    24,    32,    38,    41,    45,    49,    53
};

static const short yyrhs[] = {     3,
    22,     9,    21,     0,     3,     5,     6,     4,     7,     8,
     3,     5,    11,     6,     9,    21,     0,    12,    14,    15,
    16,    21,     0,     3,    22,     9,    18,    18,    19,    21,
     0,    13,    14,    15,    16,    21,     0,    17,    21,     0,
    12,    16,    21,     0,    20,     9,    17,     0,    22,    10,
     4,     0,     4,     0
};
...
static const short yyrline[] = { 0,
    19,    20,    21,    22,    23,    24,    25,    26,    28,    28
};

static const char * const yytname[] = {   "$","error","$illegal.","BUILTIN",
"ID","OPEN_SQ","CLOSE_SQ","EQ","NEW","SC","COMMA","DIGIT","MAIN","LOOP","OPEN_C",
"CLOSE_C","OPEN","CLOSE","SLASH","COMMENT","RETURN","start","varlist",""
};
#endif
...
static const short yypact[] = {     1,
     2,   -13,    -9,     1,    11,-32768,     3,    13,    -7,     1,
     9,-32768,    10,    24,    -1,    25,    14,-32768,    15,-32768,
    26,    16,-32768,-32768,     1,     1,    27,    17,-32768,-32768,
    34,     1,    35,-32768,    28,    36,    32,     1,-32768,    43,
    44,-32768
};
...
static const short yytable[] = {    40,
     9,     1,    10,     1,    11,     6,     7,    17,    14,    18,
     2,     3,     2,     3,    23,     4,    22,     4,     5,    13,
     5,    15,    16,    19,    29,    30,    20,    21,    24,    25,
    26,    34,    27,    28,    31,    32,    33,    39,    36,    35,
    38,    37,    41,    42
};

static const short yycheck[] = {     0,
    14,     3,    16,     3,    14,     4,     5,    15,     6,    10,
    12,    13,    12,    13,    15,    17,    18,    17,    20,     9,
    20,     9,    10,    15,    25,    26,    17,     4,     4,    16,
    16,    32,     7,    18,     8,    19,     3,    38,    11,     5,
     9,     6,     0,     0
};
